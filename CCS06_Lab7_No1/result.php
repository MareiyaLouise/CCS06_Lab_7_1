...
<h1>Thank You!</h1>
<h3>
    Congratulations <?php echo $_SESSION['fullname']; ?> (<?php echo $_SESSION['email']; ?>)! <br />
    Your score is <span style="color: blue"><?php echo $score; ?></span> out of <?php echo $manager->getQuestionSize() ;?> items <br />
    Answers:
</h3>
    <ol>
